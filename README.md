...
|   |-- Entropy_requirements.txt                # full local set
|   |-- .streamlit/config.toml                  # pinned deep-forest theme
|   |-- .env.example                            # copy to .env and add GROQ_API_KEY
|   |-- .streamlit/secrets.toml.example         # the Cloud equivalent
|   |-- static/Entropy_bg.webp                  # background artwork (served at app/static/)
|   |-- models/all-MiniLM-L6-v2/                # bundled sentence encoder (no network at load)
|   |-- Entropy_README_Round4.md
|
|-- requirements.txt                  # what Streamlit Cloud installs (CPU torch, Python 3.12)
